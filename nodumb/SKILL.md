---
name: nodumb
description: "Использовать перед любой массовой правкой, миграцией, унификацией или редизайном, а также перед повторной попыткой исправить тот же симптом. Проверяет гипотезу, причину, масштаб и применимые факты до реализации; результат — один рекомендуемый ход, его граница и проверяемый признак успеха. Также использовать, когда решение опирается на непроверенную причину, внешний факт или метрику. Не использовать для выбора продуктовой задачи, поиска edge cases и мелкой согласованной правки."
---
